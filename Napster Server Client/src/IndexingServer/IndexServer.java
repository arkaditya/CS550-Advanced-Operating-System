...
public class IndexServer extends UnicastRemoteObject implements IndexServerInterface
{
	...
	public synchronized Hashtable<String,ArrayList<String>> PeerRegistry(String peer, String portNbr, ArrayList<String> fileList) throws RemoteException {

		peerList.add(peer);
		PeerMap.put(peer,fileList);
		System.out.println("Peer Name: " + peer + "\nFiles: " + PeerMap.get(peer));
		ClientPortMapper.put(peer,portNbr);
		ClientRegistered();
		return PeerMap;
	}

	public synchronized  HashMap<String, String> PortMap() throws  RemoteException{
